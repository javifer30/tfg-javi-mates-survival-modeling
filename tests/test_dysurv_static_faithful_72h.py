...
import scripts.tune_dysurv_static_faithful_72h as tuning_module
from scripts.tune_dysurv_static_faithful_72h import (
...
from src.models.dynamic_72h.dysurv_static_faithful import DySurvStaticFaithful72h
from src.models.dynamic_72h.losses import hazards_to_survival, logistic_hazard_nll
from src.models.dynamic_72h.train_dysurv_static_faithful import (
...
def test_static_loader_uses_same_npz_but_exposes_no_temporal_or_target_features(tmp_path):
    ...
    np.savez_compressed(
        tmp_path / "train_dynamic_72h.npz",
