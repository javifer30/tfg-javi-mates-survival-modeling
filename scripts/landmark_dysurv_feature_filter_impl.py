"""Create a DySurv-compatible feature subset from the built dynamic_landmark arrays.

This script does not rebuild temporal data from MIMIC-derived CSVs. It only
selects columns from X_seq/M_seq in the already-built dynamic_landmark NPZ files.
"""
...
def main() -> None:
    ...
    parser.add_argument("--input-dir", default="data/processed/dynamic_landmark")
    parser.add_argument("--output-dir", default="data/processed/dynamic_landmark_dysurv_features")
    parser.add_argument("--input-suffix", default="dynamic_landmark")
    parser.add_argument("--output-suffix", default="dynamic_landmark")
    ...
    with (output_dir / "dynamic_landmark_dysurv_feature_summary.json").open("w", encoding="utf-8") as f:
