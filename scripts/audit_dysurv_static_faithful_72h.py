...
def write_report(base: dict, identity: dict):
    ...
    lines = [
        ...
        "",
        "The loader reads `X_static`, patient IDs, durations and events directly from `data/processed/dysurv_faithful_72h/{train,val,test}_dynamic_72h.npz`. It does not create splits or load `X_seq`/`M_seq` as model inputs. Static features are the existing train-standardized 28-column representation.",
