...
from scripts.landmark_dynamic_deephit_faithful_final_impl import run_final
...
def main():
    parser = argparse.ArgumentParser(description="Run final Dynamic-DeepHit faithful seeds for a selected landmark.")
