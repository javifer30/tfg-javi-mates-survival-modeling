...
from scripts.landmark_dysurv_static_faithful_final_impl import run_final
...
def main():
    parser = argparse.ArgumentParser(description="Run final static-only DySurv faithful seeds for a selected landmark.")
